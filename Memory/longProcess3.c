...
int main() {
    ...
    // mapping another page will increase the virtual memory size by another 4 kB

//    void *mapped_page2 = mmap(NULL, 4096, PROT_READ | PROT_WRITE, MAP_PRIVATE | MAP_ANONYMOUS, -1, 0);
//    if (mapped_page2 == MAP_FAILED) {
//        perror("mmap");
//        free(buffer);
//        return 1;
//    }
